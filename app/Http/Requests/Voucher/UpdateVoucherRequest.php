...
class UpdateVoucherRequest extends FormRequest
{
    ...
    {
        $voucherId = $this->route('voucher') instanceof Voucher ? $this->route('voucher')->id : $this->route('voucher');
    ...
    public function messages(): array
    {
        return [
            ...
            'code.regex'                         => 'Mã voucher chỉ được chứa chữ cái in hoa, chữ số, gạch ngang và gạch dưới.',

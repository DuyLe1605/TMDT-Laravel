        ...
        <div class="card-modern">
            <div class="card-modern-header d-flex justify-content-between align-items-center">
                <div class="d-flex align-items-center">
                    ...
                    <div>
                        <h5 class="fw-bold mb-1 text-dark">Chỉnh Sửa Thương Hiệu: {{ $brand->name }}</h5>
                        <div class="text-secondary small">Cập nhật thông tin nhận diện nhà mốt</div>
                    </div>
                </div>
                        ...
                        <div class="col-md-6">
                            ...
                            @if ($brand->logo)
                                <div class="mt-2 d-flex align-items-center gap-2">
                                    <span class="text-secondary small">Xem trước:</span>
                                    <img src="{{ $brand->logo }}" alt="Logo" class="rounded border" style="width: 36px; height: 36px; object-fit: cover;">
                                </div>
                            @endif
                        </div>
                            ...
                            <div class="p-3 rounded-3" style="background: var(--bg-surface-subtle); border: 1px solid var(--border-default);">
                                <div class="form-check mb-0">
                                    ...
                                    <label class="form-check-label text-dark fw-medium user-select-none" for="is_active">
                                        Kích hoạt thương hiệu (Hiển thị trên bộ lọc Storefront)
                                    </label>
                                </div>
                            </div>
                        </div>

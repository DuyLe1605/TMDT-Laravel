...
<head>
    ...
    <title>500 - Lỗi Hệ Thống &bull; Aurelia Luxury Bags</title>
    ...
    <div class="error-page-container">
        ...
        <main class="error-card-wrapper my-auto py-4">
            <div class="error-card text-center p-4 p-md-5">
                <!-- Icon Visual Badge -->
                <div class="error-visual-badge mx-auto mb-3" style="background: var(--warning-50); color: var(--warning-600); border-color: var(--warning-100);">
                    <i data-lucide="alert-triangle" style="width: 36px; height: 36px;"></i>
                </div>

                <!-- Big 500 Number -->
                <div class="error-code-badge mb-2" style="color: var(--warning-600);">
                    <span>500</span>
                </div>
                ...
                <p class="text-secondary small mb-4 mx-auto" style="max-width: 460px; line-height: 1.7; font-size: 0.92rem;">
                    Máy chủ tạm thời không thể xử lý yêu cầu này. Đội ngũ kỹ thuật đã được thông báo. Vui lòng tải lại trang hoặc quay lại sau ít phút.
                </p>

                <!-- Navigation CTAs -->
                <div class="d-flex flex-wrap justify-content-center align-items-center gap-3 mb-4">
                    <button type="button" class="btn-brand-primary py-2.5 px-4" onclick="window.location.reload()">
